...
<div id="content">
	<ol>
		...
		<li><a download href="https://github.com/spacexplorer11/Space_Dodge/releases/latest/download/Space_Dodge.zip">
			Download the latest version of the game
		</a>
		</li>
		<li>Extract/Unzip the file you downloaded.</li>
		<li>Open the extracted folder and find the file named <code>main.py</code>. <em>The path is <code>space_dodge/main.py</code></em>
		</li>
